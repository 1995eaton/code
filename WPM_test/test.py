...
def main():
	...
	print("\n\nYour typing speed is:", (lettercount / 5) * (60 / (time.time() - start_time)) , "words/minute")
	try:
		if errors == 1:
			print("You made ", errors, " error, giving you an accuracy of ", ((lettercount - errors) / lettercount) * 100, '%', sep='')
		else:
